    ...
    return (
        <div className={`detail-container width-90 ${!isDark ? 'detail-container-white' : ''}`}>
            <div className="lineup-container">
                ...
                <p className="first">NICOLAS MING B2B TOMAS BRIGNOLO&nbsp;&#8722;&nbsp;</p>
                <p className="second">NICO HERRERA B2B AGUSTÍN TOFFOLINI&nbsp;&#8722;&nbsp;</p>
                <p className="third">AGUSTIN RECOBA&nbsp;&#8722;&nbsp;</p>
                <p className="fourth">VALENTÍN BIANCHI</p>
            </div>
            <div className="fecha-container">
                <p className="fecha">Sabado 20 de Noviembre 2021 - 21:00hs</p>
            </div>
